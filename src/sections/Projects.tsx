...
import chopThumbnail from "../assets/thumbnail_chop.png";
...
export default function Projects() {
    ...
    return(
        <section id="projects" className="w-full py-20 px-6 bg-white">
            ...
            <h3 className="text-2xl md:text-xl font-semibold text-gray-600 mb-12 text-center">웹 개발 프로젝트를 통해 실무 경험을 쌓았습니다.</h3>
